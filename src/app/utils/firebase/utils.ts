...
const guestHint1 = `<h3>Als Gast darfst Du:</h3><ol><li data-list="bullet"><span class="ql-ui" contenteditable="false"></span>Nachrichten schreiben</li><li data-list="bullet"><span class="ql-ui" contenteditable="false"></span>Deine Nachrichten editieren</li><li data-list="bullet"><span class="ql-ui" contenteditable="false"></span>Mit Emojis auf Nachrichten reagieren</li><li data-list="bullet"><span class="ql-ui" contenteditable="false"></span>Channels anlegen</li><li data-list="bullet"><span class="ql-ui" contenteditable="false"></span>Deinen Avatar im Profileditor auswählen</li></ol><p><br></p><p>Um <em>eigene</em> Profilfotos hochzuladen musst Du Dich mit Name, E-Mail und Passwort registrieren.</p><p><br></p><p>Danke für Dein Verständniss. 🙂</p>`;
