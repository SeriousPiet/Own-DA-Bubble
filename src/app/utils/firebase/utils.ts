 ...
 */
const welcomemessagecontent = `<h2>Willkommen bei DABubble!</h2><p><br></p><p><strong>DABubble</strong> ist eine moderne Chat-App für effiziente Kommunikation in Channels und per Direktnachricht. Arbeite im Team oder chatte privat mit Kollegen - flexibel und intuitiv.</p><p><br></p><p>Beispielsweise kannst du auch im <span class="highlight-channel" id="dOo9k5RPlepMmo6ITTA1" contenteditable="false">#Frontend</span> alles zum Thema Frontend-Entwicklung besprechen.</p><p><br></p><p>Bei Fragen wende Dich gerne an <span class="highlight-user" id="6bg4zdOUheXQ1eE4kUyC" contenteditable="false">@Peter Wallbaum</span>. </p><p><br></p><p>Viel Spaß mit <strong>DABubble!</strong> Bei Fragen sind wir immer für dich da. Um <em>User</em> anzuschreiben, nutze die Suchfunktion.</p>`;
...
export const dabubbleBotId = '7pFP3ncwSUWT5IPrfgfB';
/**
